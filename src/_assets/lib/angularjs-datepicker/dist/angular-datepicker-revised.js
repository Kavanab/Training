  ...
  var A_DAY_IN_MILLISECONDS = 86400000
    ...
    , generateDaysColumns = function generateDaysColumns() {
      ...
      '<div class="_720kb-datepicker-calendar-days-header">',
        '<div class="dayOfWeek" ng-repeat="d in daysInString">',
          '{{d.charAt(0)}}',
        '</div>',
      '</div>'
      ];
    ...
    , generateHtmlTemplate = function generateHtmlTemplate(prevButton, nextButton, preventMobile) {
      ...
      var toReturn = [
        '<div class="_720kb-datepicker-calendar {{datepickerClass}} {{datepickerID}}" ng-class="{\'_720kb-datepicker-forced-to-open\': checkVisibility()}" ng-blur="hideCalendar()" ><div class="datebuddle"><div class="dropdown-caret"><span class="caret-outer"></span><span class="caret-inner"></span></div>',
        '</div></div>'
      ]
